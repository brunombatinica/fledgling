#Scipy.derivative robustness depedns on size of inteval and order
#Larger interval less accurate but can take deeper derivatives
#?Beyond the scope of this course ahahhahah

#Computed at 0 can be generalized(not that interesting)
