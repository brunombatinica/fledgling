#### NOW WE WANT TO EMBED THE IDENTITY AND POSITION OF THE TOKENS
...
class BigramLanguageModel(nn.Module):
    def __init__(self):
        ...
        self.position_embedding_table = nn.Embedding(block_size,n_embd) #so each position from 0 to blocksize -1 in the context will get its own embedding
    ...
    def forward(self, idx, targets=None):  
        ...
        logits = self.lm_head(x) #FCLL to map tokens onto vocab (B,T,C_vocab)
